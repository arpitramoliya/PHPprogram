...
<div class="container mt-5">
    ...
    <form method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <textarea class="form-control" id="main_description" name="main_description" rows="3" required><?php echo $result['main_description']; ?></textarea>
        </div>

        <div class="mb-3">
            <label for="benefits_title" class="form-label">Benefits Title</label>
            <input type="text" class="form-control" id="benefits_title" name="benefits_title" value="<?php echo $result['benefits_title']; ?>" required>
        </div>

        <div class="mb-3">
            <label for="benefits_description" class="form-label">Benefits Description</label>
            <textarea class="form-control" id="benefits_description" name="benefits_description" rows="3" required><?php echo $result['benefits_description']; ?></textarea>
        </div>

        <div class="mb-3">
                <label for="footer_input" class="form-label">Footer Input</label>
                <textarea class="form-control" id="footer_input" name="footer_input" rows="3" required><?php echo $result['footer_input']; ?></textarea>
            </div>
