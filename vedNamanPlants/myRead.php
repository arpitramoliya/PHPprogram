...
<body>
                ...
                <div class="plant-card">
                    ...
                    if (!empty($result['input_file'])) {
                        ...
                        if (!empty($imageArray)) {                            
                            ...
                            echo '<img src="' . $imageArray[0] .'" alt="Image" class="img-fluid " style="width:500px !important">';
                            echo '</div>';
            ...
            <div class="col-md-6">
                <div class="plant-card">
                    <div class="card-body">
                        ...
                        <h2>
                            <?= $result['benefits_title']; ?>
                        </h2>
                        <ul>
                            <li>
                                <?= $result['benefits_description']; ?>
                            </li>
                        </ul>
                        <!-- <ul>
    ...
    <center>
        ...
        <?php
            ...
            if(isset($result['footer_input'])) {
                echo $result['footer_input'];
            } else {
