...
<body>
    ...
    <div class="container mt-5">
        ...
        $stmt = $conn->prepare("SELECT * FROM plantsData LIMIT :offset, :records_per_page");
        ...
        if ($result) {
            ...
            echo '<thead><tr><th>ID</th><th>Heading</th><th>Main Title</th><th>Main Description</th><th>Benefits Title</th><th>Benefits Description</th><th>Actions</th></tr></thead>';
            echo '<tbody>';
            foreach ($result as $row) {
                ...
                echo '<td>' . $row['main_description'] . '</td>';
                echo '<td>' . $row['benefits_title'] . '</td>';
                echo '<td>' . $row['benefits_description'] . '</td>';
