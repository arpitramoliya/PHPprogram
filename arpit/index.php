...
<body>
    <div class="container mt-5">
        ...
        $('.edit-btn').click(function(){
            var id = $(this).data('id);
            var updatedTask = prompt("Enter Update Task:");

            if(updatedTask != null){
                $.post('backend.php', {updateId: id, updateTask: updateTask}, function(res){
                    tosatr.success(res);
                    location.reload();
                }).fail(function(){
                    toastr.erroe("Error occurred);
                });
            }
        });
        ...
        $('.edit-btn').click(function(){
            var id = $(this).data('id');
            var updatedTask = prompt("Enetr update task:");
        ...
        $('.edit-btn').click(function(){
            var id = $(this).data('id');
            var updateTask = prompt("Enetr update task:");
